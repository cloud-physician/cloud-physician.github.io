  ...
  $.fn.stickyNavbar = function(prop) {
    ...
    return this.each(function() {
      ...
      menuItems.click(function(e) {
        ...
        var toScroll = $self.hasClass(options.unstickyModeClass) || $self.is('[style*="static"]') ? sectionOffsets[currentHref] + 'px' : sectionOffsets[currentHref] - thisHeight + 2 + 'px';
        ...
        $('html, body').stop().animate({
          ...
          complete: function () {
            console.log($self.is('[style*="static"]'));
          }
        });
      });
